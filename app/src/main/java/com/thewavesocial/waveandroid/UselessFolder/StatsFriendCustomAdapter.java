...
//
//    public StatsFriendCustomAdapter(EventStatsActivity sharedPreferencesContext, List<User> userList)
//    {
//        super();
...
//                    if (image != null)
//                        holder.img.setImageDrawable( UtilityClass.toRoundImage(sharedPreferencesContext.getResources(), image));
//                }
//            });
//
